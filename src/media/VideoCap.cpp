...
bool VideoCap::start(string fileName) {
	width = 640;
	height = 480;
	stopFlag = false;
	if (pFormatCtx != NULL) {
	...
	*/
	...
	noMoreFrame = false;
	thread video{ &VideoCap::videoThreadFunc, this };
...
int VideoCap::getVideoFrameRate(AVStream* inputVideoStream) {
	int frameRate = 40;
